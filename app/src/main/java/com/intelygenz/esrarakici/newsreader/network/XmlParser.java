...
public class XmlParser {
    ...
    private final String contentTag = "category";
        ...
        while (xmlPullParser.next() != XmlPullParser.END_DOCUMENT) {
            ...
            if (isItem) {
                if (name.equalsIgnoreCase(titleTag)) {
                    title = result;
                } else if (name.equalsIgnoreCase(contentTag)){
            ...
            if (title != null && link != null && description != null && date != null) {
                ...
                NewsItem item = new NewsItem(title, link, content, description, date, imageLink);
                items.add(item);
