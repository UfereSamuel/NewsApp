...
public class DataBaseHandler {
 ...
 //news table method
    ...
    public void insertNewsInfo(NewsItem newsItem) {
        ...
        cv.put("content"           ,  newsItem.Content);
    ...
    public List<NewsItem> getAllNews() {
        ...
        while (!cursor.isAfterLast()) {
            NewsItem newsInfo = new NewsItem(cursor.getString(1),cursor.getString(0),cursor.getString(2),cursor.getString(3),cursor.getString(4), cursor.getString(5));
